...
TaiChi.o: TaiChi.cu
	$(CUDA_CC) $(NVCC_FLAGS) -o TaiChi.o -c TaiChi.cu $(CUDA_INCLUDES) $(CUDA_LIBS) -D VALUE_TYPE=$(VALUE_TYPE) -D NUM_RUN=$(NUM_RUN)
main.o: main.c 
	$(CUDA_CC) $(NVCC_FLAGS) -o main.o -c main.c $(CUDA_INCLUDES) $(CUDA_LIBS) -D VALUE_TYPE=$(VALUE_TYPE) -D NUM_RUN=$(NUM_RUN)
spmv: TaiChi.o main.o
	$(CUDA_CC) $(NVCC_FLAGS) -o spmv 
